...
public partial class AddProduct : System.Web.UI.Page
{
    ...
    {
        string SqlStr = "select  [productId] from [productTbl] where [productId]='" + this.TextBox1.Text + "'";
     ...
     protected void Button1_Click(object sender, EventArgs e)
          {
             if (ProductExist())
          {
          //  Label1.Text = " Product Is Exist ";
           // Label1.Visible = true;
              MsgBox("Product Is Exist");
          }
            else
          {
                   if (this.FileUpload1.PostedFile.ContentLength != 0)
                   {
                      string destDir = Server.MapPath("./pImage");
            ...
            string sqlMsgStr2 = "insert into [productTbl]([productId],[productName],[Price],[image ],[category],[quantity]) values('";
            sqlMsgStr2 += this.TextBox1.Text + "','" + this.TextBox2.Text + "','" + this.TextBox3.Text + "','" + "pImage/" + fileName + "','" + this.TextBox4.Text + "','" + this.TextBox5.Text + "')";
