...
public partial class MyProfileAdm : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            if (user1.AdminExist(this.TextBox1.Text, this.TextBox4.Text))
            {
                user1.UserEmail = this.TextBox1.Text;
                user1.UpdateAdminPassword(this.TextBox5.Text);
        ...
        {
            Label1.Text = " Enter A new Passwrord ( Min 4 Characters )";
            Label1.Visible = true;
        }
    }
